...
критическая ошибка(Кр), четыре незначительные(незн). По типам ошибки делятся на: одна контентная(конт), две функциональные (Ф),
три логические(лог).
...
Было выполнено 35 функциональных тестов. 24 упал (69%), 11 прошли (31%). Проблема в одном из упавших тестов 
